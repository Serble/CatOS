...
CONF_SRC_DIR="src/conf"              # files installed into the root fs /conf
...
APPS="idle init sh echo ls cat touch ef condemo hello counter spin filetest argtest sigdemo time sleep poweroff"
